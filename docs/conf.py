...
edit_on_github_branch = "master/chipscopy"
...
# Don't reorder methods - keep in order of source code. Developers know best.
autodoc_member_order = "bysource"

# Look at the docs in the __init__ of the class for the class docs
...
latex_documents = [
    (master_doc, 'chipscopy.tex', 'chipscopy', 'Xilinx', 'manual'),
]
...
man_pages = [(master_doc, 'chipscopy', 'chipscopy', [author], 1)]
...
texinfo_documents = [
    (master_doc, 'chipscopy', 'chipscopy', author, 'Xilinx', 'Python ChipScope API.', 'Miscellaneous'),
]
...
class FilterForIssue123(pylogging.Filter):
    ...
    def filter(self, record: pylogging.LogRecord) -> bool:
        # Fixes WARNING: Cannot treat a function defined as a local function:
        #     "chipscopy.api.ibert.link.Link"  (use @functools.wraps)
