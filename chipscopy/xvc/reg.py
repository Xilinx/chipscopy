...
class XVCCore(XVCRegister):
    def __init__(self, core_type=0xFF, value_byte_len=0x40):
...
class XVCAxisCore(XVCCore):
    def __init__(self, core_type=0x1, value_byte_len=0x90):
        XVCCore.__init__(self, core_type, value_byte_len=value_byte_len)
