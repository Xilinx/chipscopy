...
# -----------
#
# This DDR utility example provides functionality of rounding vref percentage values to
...
def convert_vref_pct_to_code(ddr: DDR, mg_mode: str, req_vref="50"):
    ...
    if mg_mode == "READ":
        ...
        print(
            f" Requested Read Vref %: {req_vref} actual % : {ddr.get_eye_scan_vref_percentage(vref_code)} "
        )
    elif mg_mode == "WRITE":
