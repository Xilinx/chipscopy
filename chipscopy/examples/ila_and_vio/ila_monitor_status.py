...
# 3. Ultrascale board such as a KCU105
...
# ## 3. Program the Device
#
# After this step the device is programmed with the example bitstream
#
...
for switch_value in [0, 1, 0]:
    ...
    vio.write_probes({"ks_demo_i/slow_counter_0_UP": switch_value})
    # Sleep 2.0 seconds.
    sleep(2.0)
