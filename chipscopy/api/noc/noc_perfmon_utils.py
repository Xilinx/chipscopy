    ...
    def block_reset(self):
        if self.vio is not None:
            self.vio.write_probes(
                {
                    "sptg_axi_mode_i/axis_vio_0_probe_out0": 0x0,
                    "sptg_axi_mode_i/axis_vio_0_probe_out1": 0x0,
                }
            )
            self.vio.write_probes(
                {
                    "sptg_axi_mode_i/axis_vio_0_probe_out0": 0x1,
                    "sptg_axi_mode_i/axis_vio_0_probe_out1": 0x1,
                }
            )
